    ...
    <form wire:submit.prevent="usr">
        ...
        <div class="grid grid-cols-2 gap-4">
                            ...
                            function app() {
                                return {
                                    ...
                                    initDate() {
                                        ...
                                        @this.fecha=this.year +"-"+ ('0'+ (this.month+1)).slice(-2) +"-"+ ('0' + today.getDate()).slice(-2);
                                    ...
                                    getDateValue(date) {
                                        ...
                                        @this.fecha=selectedDate.getFullYear() +"-"+ ('0'+ (selectedDate.getMonth()+1)).slice(-2) +"-"+ ('0' + selectedDate.getDate()).slice(-2);
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="ubicacion" wire:model.defer="ubicacion" class="block mt-1 w-full" type="text" name="ubicacion" :value="old('ubicacion')" required />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="descripcion" wire:model.defer="descripcion" class="block mt-1 w-full" type="text" name="descripcion" :value="old('descripcion')" required />
                @error('descripcion') <x-jet-label class="text-red-400 italic" value="{{ $message}}" />  @enderror

            </div>
            <div class="mt-4">
                <x-jet-label for="tecnico" value="{{ 'Técnico' }}" />
                <x-jet-input id="tecnico" wire:model.defer="tec_id" class="block mt-1 w-full" type="text" name="tecnico"  required />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="cliente" wire:model.defer="cli_id" class="block mt-1 w-full" type="text" name="cliente" required />
